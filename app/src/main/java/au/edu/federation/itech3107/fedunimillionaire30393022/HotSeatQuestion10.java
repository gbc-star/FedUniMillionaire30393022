...
public class HotSeatQuestion10 extends AppCompatActivity {
...
//        read json file - hard question
        InputStream isH = HotSeatQuestion10.this.getClass().getClassLoader().getResourceAsStream("assets/" + "questions-hard.txt");
...
//        read json file - win money and safe money
        InputStream is_money = HotSeatQuestion10.this.getClass().getClassLoader().getResourceAsStream("assets/" + "money.json");
...
//            get the length of json_array,then use random to choose a number from 0 to json_array.length
            ...
            tv1.setText("10. " + "(" + json_object1.getString("difficulty") + ")" + json_object1.getString("question"));
            ...
            new CountDownTimer(15000, 1000) {
                ...
                public void onFinish() {
                    AlertDialog textTips = new AlertDialog.Builder(HotSeatQuestion10.this)
                            .setTitle("Sorry !!")
                            .setMessage("Time out! Press OK will go back to the first page.")
                            .setPositiveButton("OK", (dialogInterface, i) -> {
                                Intent intent = new Intent(HotSeatQuestion10.this, WelcomePage.class);
                ...
                if (isChecked) {
                    try {
                        ...
                        AlertDialog textTips = new AlertDialog.Builder(HotSeatQuestion10.this)
                                ...
                                .setPositiveButton("OK", (dialogInterface, i) -> {
                                    Intent intent = new Intent(HotSeatQuestion10.this, FinishPage.class);
        ...
        btn1.setOnClickListener(v -> {
            Intent intent = new Intent(HotSeatQuestion10.this, HotSeatQuestion11.class);
            startActivity(intent);
        });
    }
