...
public class HotSeatQuestion6 extends AppCompatActivity {
...
//        read json file - medium question
        InputStream isM = HotSeatQuestion6.this.getClass().getClassLoader().getResourceAsStream("assets/" + "questions-medium.txt");
...
//        read json file - win money and safe money
        InputStream is_money = HotSeatQuestion6.this.getClass().getClassLoader().getResourceAsStream("assets/" + "money.json");
...
//            get the length of json_array,then use random to choose a number from 0 to json_array.length
            ...
            tv1.setText("6. " + "(" + json_object1.getString("difficulty") + ")" + json_object1.getString("question"));
            ck1.setText("A. " + json_arrayQ1.getString(0));
            ck2.setText("B. " + json_arrayQ1.getString(2));
            ...
            new CountDownTimer(15000, 1000) {
                ...
                public void onFinish() {
                    AlertDialog textTips = new AlertDialog.Builder(HotSeatQuestion6.this)
                            .setTitle("Sorry !!")
                            .setMessage("Time out! Press OK will go back to the first page.")
                            .setPositiveButton("OK", (dialogInterface, i) -> {
                                Intent intent = new Intent(HotSeatQuestion6.this, WelcomePage.class);
            ...
            ck1.setOnCheckedChangeListener((buttonView, isChecked) -> {
                if (isChecked) {
                    try {
                        ...
                        JSONObject json_object_money = json_array_money.getJSONObject(5);
                        AlertDialog textTips = new AlertDialog.Builder(HotSeatQuestion6.this)
                                .setTitle("Sorry !!")
                                .setMessage("Wrong! You lose the game, no safe money!")
                                .setPositiveButton("OK", (dialogInterface, i) -> {
                                    Intent intent = new Intent(HotSeatQuestion6.this, FinishPage.class);
        ...
        btn1.setOnClickListener(v -> {
            Intent intent = new Intent(HotSeatQuestion6.this, HotSeatQuestion7.class);
            startActivity(intent);
        });
    }
