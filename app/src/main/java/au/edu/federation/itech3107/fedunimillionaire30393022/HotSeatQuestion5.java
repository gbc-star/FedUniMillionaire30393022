...
public class HotSeatQuestion5 extends AppCompatActivity {
...
//        read json file - easy question
        InputStream isE = HotSeatQuestion5.this.getClass().getClassLoader().getResourceAsStream("assets/" + "questions-easy.txt");
...
//        read json file - win money and safe money
        InputStream is_money = HotSeatQuestion5.this.getClass().getClassLoader().getResourceAsStream("assets/" + "money.json");
...
//            get the length of json_array,then use random to choose a number from 0 to json_array.length
            ...
            tv1.setText("5. " + "(" + json_object1.getString("difficulty") + ")" + json_object1.getString("question"));
            ck1.setText("A. " + json_arrayQ1.getString(0));
            ck2.setText("B. " + json_arrayQ1.getString(2));
            ck3.setText("C. " + json_arrayQ1.getString(1));
            ck4.setText("D. " + json_object1.getString("correct_answer"));
            ...
            new CountDownTimer(15000, 1000) {
                ...
                public void onFinish() {
                    AlertDialog textTips = new AlertDialog.Builder(HotSeatQuestion5.this)
                            .setTitle("Sorry !!")
                            .setMessage("Time out! Press OK will go back to the first page.")
                            .setPositiveButton("OK", (dialogInterface, i) -> {
                                Intent intent = new Intent(HotSeatQuestion5.this, WelcomePage.class);
            ...
            ck1.setOnCheckedChangeListener((buttonView, isChecked) -> {
                if (isChecked) {
                    try {
                        ...
                        JSONObject json_object_money = json_array_money.getJSONObject(4);
                        AlertDialog textTips = new AlertDialog.Builder(HotSeatQuestion5.this)
                                .setTitle("Sorry !!")
                                .setMessage("Wrong! You lose the game, no safe money!")
                                .setPositiveButton("OK", (dialogInterface, i) -> {
                                    Intent intent = new Intent(HotSeatQuestion5.this, FinishPage.class);
        ...
        btn1.setOnClickListener(v -> {
            Intent intent = new Intent(HotSeatQuestion5.this, HotSeatQuestion6.class);
            startActivity(intent);
        });
    }
