...
public class HotSeatQuestion11 extends AppCompatActivity {
...
//        read json file - hard question
        InputStream isH = HotSeatQuestion11.this.getClass().getClassLoader().getResourceAsStream("assets/" + "questions-hard.txt");
...
//        read json file - win money and safe money
        InputStream is_money = HotSeatQuestion11.this.getClass().getClassLoader().getResourceAsStream("assets/" + "money.json");
...
//            get the length of json_array,then use random to choose a number from 0 to json_array.length
            JSONObject QA = new JSONObject(stringBuilderH.toString());
            ...
            tv1.setText("11. " + "(" + json_object1.getString("difficulty") + ")" + json_object1.getString("question"));
            ck1.setText("A. " + json_arrayQ1.getString(0));
            ck2.setText("B. " + json_object1.getString("correct_answer"));
            ck3.setText("C. " + json_arrayQ1.getString(2));
            ck4.setText("D. " + json_arrayQ1.getString(1));
            ...
            new CountDownTimer(15000, 1000) {
                ...
                public void onFinish() {
                    AlertDialog textTips = new AlertDialog.Builder(HotSeatQuestion11.this)
                            .setTitle("Sorry !!")
                            .setMessage("Time out! Press OK will go back to the first page.")
                            .setPositiveButton("OK", (dialogInterface, i) -> {
                                Intent intent = new Intent(HotSeatQuestion11.this, WelcomePage.class);
            ...
            ck1.setOnCheckedChangeListener((buttonView, isChecked) -> {
                if (isChecked) {
                    try {
                        ...
                        JSONObject json_object_money = json_array_money.getJSONObject(9);
                        AlertDialog textTips = new AlertDialog.Builder(HotSeatQuestion11.this)
                                .setTitle("Sorry !!")
                                .setMessage("Wrong! You lose the game, you safe money: $ " + json_object_money.getString("safe_money"))
                                .setPositiveButton("OK", (dialogInterface, i) -> {
                                    Intent intent = new Intent(HotSeatQuestion11.this, FinishPage.class);
                                    intent.putExtra("Win_Money","32000");
            ...
            ck2.setOnCheckedChangeListener((buttonView, isChecked) -> {
                if (isChecked) {
                    ...
                    try {
                        JSONObject Money = new JSONObject(stringBuilder_money.toString());
                        JSONArray json_array_money = Money.getJSONArray("money");
                        JSONObject json_object_money = json_array_money.getJSONObject(10);
...
//        get current time. reference:https://blog.csdn.net/qq_45241988/article/details/103766921
        ...
        btn1.setOnClickListener(v -> {
            Intent intent = new Intent(HotSeatQuestion11.this, FinishPage.class);
            intent.putExtra("Win_Money","1000000");
            intent.putExtra("WinTime",simpleDateFormat.format(date));
            startActivity(intent);
        });
    }
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        if (event.getKeyCode() == KeyEvent.KEYCODE_BACK) {
            //reference:https://blog.csdn.net/qq929371489/article/details/80519218
            return true;
        } else {
