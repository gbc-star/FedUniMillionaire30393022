...
public class HotSeatQuestion3 extends AppCompatActivity {
...
//        read json file - easy question
        InputStream isE = HotSeatQuestion3.this.getClass().getClassLoader().getResourceAsStream("assets/" + "questions-easy.txt");
...
//        read json file - win money and safe money
        InputStream is_money = HotSeatQuestion3.this.getClass().getClassLoader().getResourceAsStream("assets/" + "money.json");
...
//            get the length of json_array,then use random to choose a number from 0 to json_array.length
            ...
            new CountDownTimer(15000, 1000) {
                ...
                public void onFinish() {
                    AlertDialog textTips = new AlertDialog.Builder(HotSeatQuestion3.this)
                            .setTitle("Sorry !!")
                            .setMessage("Time out! Press OK will go back to the first page.")
                            .setPositiveButton("OK", (dialogInterface, i) -> {
                                Intent intent = new Intent(HotSeatQuestion3.this, WelcomePage.class);
                ...
                if (isChecked) {
                    try {
                        ...
                        AlertDialog textTips = new AlertDialog.Builder(HotSeatQuestion3.this)
                                ...
                                .setPositiveButton("OK", (dialogInterface, i) -> {
                                    Intent intent = new Intent(HotSeatQuestion3.this, FinishPage.class);
        ...
        btn1.setOnClickListener(v -> {
            Intent intent=new Intent(HotSeatQuestion3.this, HotSeatQuestion4.class);
            startActivity(intent);
        });
    }
