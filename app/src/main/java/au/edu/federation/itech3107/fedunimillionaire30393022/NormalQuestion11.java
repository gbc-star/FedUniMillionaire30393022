...
public class NormalQuestion11 extends AppCompatActivity {
...
//        read json file - hard question
        InputStream isH = NormalQuestion11.this.getClass().getClassLoader().getResourceAsStream("assets/" + "questions-hard.txt");
...
//        read json file - win money and safe money
        InputStream is_money = NormalQuestion11.this.getClass().getClassLoader().getResourceAsStream("assets/" + "money.json");
            ...
            ck1.setOnCheckedChangeListener((buttonView, isChecked) -> {
                if (isChecked) {
                    try {
                        ...
                        AlertDialog textTips = new AlertDialog.Builder(NormalQuestion11.this)
                                .setTitle("Sorry !!")
                                .setMessage("Wrong! You lose the game, you safe money: $ " + json_object_money.getString("safe_money"))
                                .setPositiveButton("OK", (dialogInterface, i) -> {
                                    Intent intent = new Intent(NormalQuestion11.this, FinishPage.class);
