...
public class NormalQuestion1 extends AppCompatActivity {
...
//        read json file - easy question
        InputStream isE = NormalQuestion1.this.getClass().getClassLoader().getResourceAsStream("assets/" + "questions-easy.txt");
...
//        read json file - hard question
        InputStream isH = NormalQuestion1.this.getClass().getClassLoader().getResourceAsStream("assets/" + "questions-hard.txt");
...
//        read json file - medium question
        InputStream isM = NormalQuestion1.this.getClass().getClassLoader().getResourceAsStream("assets/" + "questions-medium.txt");
...
//        read json file - win money and safe money
        InputStream is_money = NormalQuestion1.this.getClass().getClassLoader().getResourceAsStream("assets/" + "money.json");
...
//            get the length of json_array,then use random to choose a number from 0 to json_array.length
            ...
            ck2.setOnCheckedChangeListener((buttonView, isChecked) -> {
                if (isChecked) {
                    AlertDialog textTips = new AlertDialog.Builder(NormalQuestion1.this)
                            .setTitle("Sorry !!")
                            .setMessage("Wrong! You lose the game, no safe money!")
                            .setPositiveButton("OK", (dialogInterface, i) -> {
                                Intent intent = new Intent(NormalQuestion1.this, FinishPage.class);
        ...
        btn1.setOnClickListener(v -> {
            Intent intent = new Intent(NormalQuestion1.this, NormalQuestion2.class);
            startActivity(intent);
            finish();
        });
    }
