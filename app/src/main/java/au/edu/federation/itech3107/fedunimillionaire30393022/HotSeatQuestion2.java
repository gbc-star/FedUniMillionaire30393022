...
public class HotSeatQuestion2 extends AppCompatActivity {
...
//        read json file - easy question
        InputStream isE = HotSeatQuestion2.this.getClass().getClassLoader().getResourceAsStream("assets/" + "questions-easy.txt");
...
//        read json file - win money and safe money
        InputStream is_money = HotSeatQuestion2.this.getClass().getClassLoader().getResourceAsStream("assets/" + "money.json");
...
//            get the length of json_array,then use random to choose a number from 0 to json_array.length
            ...
            tv1.setText("2. " + "(" + json_object1.getString("difficulty") + ")" + json_object1.getString("question"));
            ...
            new CountDownTimer(15000, 1000) {
                ...
                public void onFinish() {
                    AlertDialog textTips = new AlertDialog.Builder(HotSeatQuestion2.this)
                            .setTitle("Sorry !!")
                            .setMessage("Time out! Press OK will go back to the first page.")
                            .setPositiveButton("OK", (dialogInterface, i) -> {
                                Intent intent = new Intent(HotSeatQuestion2.this, WelcomePage.class);
            ...
            ck1.setOnCheckedChangeListener((buttonView, isChecked) -> {
                if (isChecked) {
                    try {
                        ...
                        JSONObject json_object_money = json_array_money.getJSONObject(1);
                        AlertDialog textTips = new AlertDialog.Builder(HotSeatQuestion2.this)
                                .setTitle("Sorry !!")
                                .setMessage("Wrong! You lose the game, no safe money!")
                                .setPositiveButton("OK", (dialogInterface, i) -> {
                                    Intent intent = new Intent(HotSeatQuestion2.this, FinishPage.class);
        ...
        btn1.setOnClickListener(v -> {
            Intent intent = new Intent(HotSeatQuestion2.this, HotSeatQuestion3.class);
            startActivity(intent);
        });
    }
    @Override
