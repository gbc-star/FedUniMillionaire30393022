...
public class NormalQuestion8 extends AppCompatActivity {
...
//        read json file - medium question
        InputStream isM = NormalQuestion8.this.getClass().getClassLoader().getResourceAsStream("assets/" + "questions-medium.txt");
...
//        read json file - win money and safe money
        InputStream is_money = NormalQuestion8.this.getClass().getClassLoader().getResourceAsStream("assets/" + "money.json");
...
//            get the length of json_array,then use random to choose a number from 0 to json_array.length
            ...
            ck2.setOnCheckedChangeListener((buttonView, isChecked) -> {
                if (isChecked) {
                    try {
                        ...
                        JSONArray json_array_money = Money.getJSONArray("money");
                        JSONObject json_object_money = json_array_money.getJSONObject(7);
                        AlertDialog textTips = new AlertDialog.Builder(NormalQuestion8.this)
                                .setTitle("Sorry !!")
                                .setMessage("Wrong! You lose the game, you safe money: $ " + json_object_money.getString("safe_money"))
                                .setPositiveButton("OK", (dialogInterface, i) -> {
                                    Intent intent = new Intent(NormalQuestion8.this, FinishPage.class);
        ...
        btn1.setOnClickListener(v -> {
            Intent intent = new Intent(NormalQuestion8.this, NormalQuestion9.class);
            startActivity(intent);
            finish();
        });
    }
