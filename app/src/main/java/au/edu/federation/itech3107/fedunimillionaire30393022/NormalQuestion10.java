...
public class NormalQuestion10 extends AppCompatActivity {
...
//        read json file - hard question
        InputStream isH = NormalQuestion10.this.getClass().getClassLoader().getResourceAsStream("assets/" + "questions-hard.txt");
...
//        read json file - win money and safe money
        InputStream is_money = NormalQuestion10.this.getClass().getClassLoader().getResourceAsStream("assets/" + "money.json");
...
//            get the length of json_array,then use random to choose a number from 0 to json_array.length
            ...
            ck1.setOnCheckedChangeListener((buttonView, isChecked) -> {
                if (isChecked) {
                    try {
                        ...
                        AlertDialog textTips = new AlertDialog.Builder(NormalQuestion10.this)
                                .setTitle("Sorry !!")
                                .setMessage("Wrong! You lose the game, you safe money: $ " + json_object_money.getString("safe_money"))
                                .setPositiveButton("OK", (dialogInterface, i) -> {
                                    Intent intent = new Intent(NormalQuestion10.this, FinishPage.class);
        ...
        btn1.setOnClickListener(v -> {
            Intent intent = new Intent(NormalQuestion10.this, NormalQuestion11.class);
            startActivity(intent);
            finish();
        });
    }
