...
public class NormalQuestion9 extends AppCompatActivity {
...
//        read json file - medium question
        InputStream isM = NormalQuestion9.this.getClass().getClassLoader().getResourceAsStream("assets/" + "questions-medium.txt");
...
//        read json file - win money and safe money
        InputStream is_money = NormalQuestion9.this.getClass().getClassLoader().getResourceAsStream("assets/" + "money.json");
...
//            get the length of json_array,then use random to choose a number from 0 to json_array.length
            ...
            ck2.setOnCheckedChangeListener((buttonView, isChecked) -> {
                if (isChecked) {
                    try {
                        ...
                        JSONArray json_array_money = Money.getJSONArray("money");
                        JSONObject json_object_money = json_array_money.getJSONObject(8);
                        AlertDialog textTips = new AlertDialog.Builder(NormalQuestion9.this)
                                .setTitle("Sorry !!")
                                .setMessage("Wrong! You lose the game, you safe money: $ " + json_object_money.getString("safe_money"))
                                .setPositiveButton("OK", (dialogInterface, i) -> {
                                    Intent intent = new Intent(NormalQuestion9.this, FinishPage.class);
        ...
        btn1.setOnClickListener(v -> {
            Intent intent = new Intent(NormalQuestion9.this, NormalQuestion10.class);
            startActivity(intent);
            finish();
        });
    }
